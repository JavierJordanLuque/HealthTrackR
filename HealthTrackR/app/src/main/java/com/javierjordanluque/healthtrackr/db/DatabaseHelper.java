...
import com.javierjordanluque.healthtrackr.util.exceptions.DBInitializingException;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    private static final String DATABASE_NAME = "healthtrackr.db";
    private static final int DATABASE_VERSION = 1;
    private final String DATABASE_SCRIPT = "healthtrackr.sql";
